...
export default function Home() {
  return <>
    ...
    <section className="section detector-section"><div className="detector-grid-bg"/><div className="shell detector-layout">
      ...
      <Reveal delay={120}><div className="detector-product-frame"><img src="/product/smart-detectors-dashboard-real.webp" alt="InCheck 360 Smart Detectors dashboard showing detector alerts, temperature, humidity and connection status" loading="lazy" decoding="async" width="1915" height="589"/></div></Reveal>
    </div></section>
