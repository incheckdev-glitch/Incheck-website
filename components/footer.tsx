...
export function Footer() {
  return <footer className="site-footer">
    <div className="shell footer-grid">
      ...
      <div><strong>Product</strong><Link href="/platform">Platform</Link><Link href="/product/checklists">Checklists</Link><Link href="/product/journal">Journal</Link><Link href="/product/sops">Reference Materials</Link><Link href="/smart-detectors">Smart Detectors</Link><Link href="/integrations">Integrations</Link><Link href="/plans">Plans</Link></div>
