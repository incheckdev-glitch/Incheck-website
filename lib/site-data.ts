...
export const features: Feature[] = [
  ...
  },
  {
    ...
    short: 'Move from finding to verified closure in one structured audit workflow.',
    description: 'An upcoming dedicated audit module for planned audits, findings, evidence, assigned follow-up, verification and reporting. Inspection-style checklists can already be used today while this workflow is completed.',
    bullets: ['Structured audit programs', 'Findings and evidence', 'Assigned finding follow-up', 'Verification and reporting'],
    tone: 'cyan',
    status: 'coming-soon',
  },
  {
    ...
    short: 'Turn structured operational data into clearer management signals.',
    description: 'An upcoming intelligence layer designed to surface recurring issues, changing patterns, risk signals and concise management summaries from InCheck 360 operational data.',
